...
/**
 * @brief A function that receive data.(Can only be used by Receiver).
 *
 * It is the function that receive data from the I2C data bus. This function  can be used by Master Receiver and Slave Receiver.
 *
...
/**
 * @brief A function that the slave stop receiving data.(Can only be used by Slave Receiver).
 *
 * It is the function that the slave stop receiving any more data from the I2C data bus by disconnect the device from I2C bus.
 *
 * @param Doesn't send any input parameters.
 *
 * @return Doesn't return any values.
